...
public class HandyGyro implements SensorEventListener {
    private static final String TAG = HandyGyro.class.getSimpleName();
    ...
    public HandyGyro(Context context) {
    ...
    private void loadNewSensorData(SensorEvent event) {
        ...
        if (type == Sensor.TYPE_MAGNETIC_FIELD) {
            ...
            if (field>25 && field<65){
                ...
                //---------->info.setText("Achtung hier: loadNewSensorData");
        }
        }
    }
